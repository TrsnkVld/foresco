...
export default {
	...
	data: () => ({
		...
		sliderInfoItems: [
			...
			{
				title: '🔥 Заголовок',
				text: 'чтение qr, расшаривание ссылок, написание сервера',
			},
			{
				title: '🔥 Заголовок',
				text: 'чтение генераций',
			},
			{
				title: '🔥 Заголовок',
				text: 'Сервер на Elexir',
			},
			{
				title: '🔥 Заголовок',
			...
			{
				title: '🔥 Заголовок',
				text: 'поддержка нескольких устройств в реальном времени',
			},
			{
				title: '🔥 Заголовок',
